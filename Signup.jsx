...
function Signup() {
    ...
    return(
        <div className="d-flex flex-column vh-100" style={{ backgroundImage: "url('public/varshi.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        {/* Navigation Bar */}
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
          <a className="navbar-brand text-purple" href="#" style={{ fontWeight: 'bold', fontSize: '28px', color: '#8A2BE2' }}>WAY TO GO</a>
        </nav>
